...
const Hero = () => (
    ...
    <h1 className="min-h-screen relative overflow-hidden">
        ...
        <div className="absolute w-full min-h-screen z-10">
            <div className='max-w-screen-xl py-14 px-5 lg:px-10 mx-auto grid lg:grid-cols-2 h-full'>
                <div className="flex items-center justify-center flex-col py-10 gap-y-5 lg:gap-10 ps-2 lg:px-10 introFade">
                    <div className="text-4xl lg:text-6xl font-bold text-black/85 pt-16">The <i className=''>Web based </i> marketing agency.</div>
